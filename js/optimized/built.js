...
var projects = {
    ...
    "htmlInnerTemplates": [{
        ...
        "picture": "<section class=\"entry-content\"><figure class=\"entry-fig\"><img class=\"entry-pic\" src=\"%data%\" ",
        "srcset": "srcset=\"%data%\" sizes=\"(min-width: 1601px) 25vw, (min-width: 1001px) 33vw, (min-width: 701px) 33vw, (min-width: 501px) 45vw, 95vw\" ",
        "alt": "alt=\"%data%\"></img></figure>",
        "description": "<aside class=\"entry-description\"><p>%data%</p></aside></section>"
    }, {
        "dates": "<footer class=\"entry-footer\"><hr><p class=\"date-location-text\">%data%</p></footer>"
    }],
    "projects": [{
        "name": "Customer1",
        "picture": "http://placehold.it/600x400",
        "srcset": "http://placehold.it/300x400 300w, http://placehold.it/400x400 400w, http://placehold.it/500x400 500w",
        "url": "#",
